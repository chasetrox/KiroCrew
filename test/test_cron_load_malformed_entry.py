...
# Execution selectors: a present non-string is MALFORMED (record skipped),
# never coerced — a script job whose selector degraded to "" would silently
# become an LLM agent job (mode fallthrough in _cron_callback).
_SELECTOR_FIELDS = ["script", "command", "agent_id"]
...
_NUMERIC_POISONS = [float("nan"), float("inf"), 10**400, "60", True]
