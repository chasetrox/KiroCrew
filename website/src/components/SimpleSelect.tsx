...
export default function SimpleSelect({ options, optionLabels, optionIcons, value, onChange, action, clearLabel, triggerFallback, disabled, style, id, className, 'aria-label': ariaLabel, title }: SimpleSelectProps) {
